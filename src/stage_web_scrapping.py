...
class WebScrappingStage(BaseStage):
    """Stage for scrapping the data from the internet.
    """
    name = "web_scrapping"
    logger = logging.getLogger("pipeline").getChild("web_scrapping_stage")
    ...
    def pre_run(self, args):
        ...
        """
        self.logger.info("=" * 40)
        self.logger.info("Executing web scrapping stage")
